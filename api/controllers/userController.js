...
class User {
   static index = async (_, response) => {
      ...
      try {
         const roles = await userServices.getUsers()
   ...
   static show = async (request, response) => {
      ...
      try {
         const role = await userServices.showRegisters(id)
         return !role ?
   ...
   static create = async (request, response) => {
      ...
      try {
         const newRole = await userServices.createUser(role)
   ...
   static update = async (request, response) => {
      ...
      const role = request.body
      try {
         await userServices.updateUser(role, id)
         const updatedRole = await userServices.showRegisters(id)
